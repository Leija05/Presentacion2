    ...
    projects: [
      {
        ...
        video: process.env.PUBLIC_URL + '/videos/Restaurant.mp4',
        image: process.env.PUBLIC_URL + '/img/RestaurantProyect.png',
      ...
      },
      {
        ...
        video: process.env.PUBLIC_URL + '/videos/Panaderia.mp4',
        image: process.env.PUBLIC_URL + '/img/PanaderiaElectron.png',
      ...
      },
      {
        ...
        video: process.env.PUBLIC_URL + '/videos/Jodify.mp4',
        image: process.env.PUBLIC_URL + '/img/Jodify.png',
